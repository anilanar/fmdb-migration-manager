...
Pod::Spec.new do |s|
  ...
  # s.homepage     = "http://EXAMPLE/fmdb-migration-manager"
  ...
  # s.authors      = { "Anil Anar" => "aanar@videa.com.tr", "other author" => "email@address.com" }
  # s.author       = 'Anil Anar', 'other author'
  ...
  # s.source       = { :git => "http://EXAMPLE/fmdb-migration-manager.git", :tag => "0.0.1" }
